...
class ScatterDensityAxes(plt.Axes):
    ...
    def scatter_density(self, x, y, z, dpi=72, downres_factor=4, color=None, cmap=None,
                        alpha=1.0, norm=None, **kwargs):
        """
        Make a density plot of the (x, y, z) scatter data.
        ...
        self.set_zlim(np.min(z), np.max(z))

        scatter = ScatterDensityArtist(self, x, y, z, dpi=dpi, downres_factor=downres_factor,
